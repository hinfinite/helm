...
func (mock *MockConfigMapsInterface) Get(context context.Context, name string, options metav1.GetOptions) (*v1.ConfigMap, error) {
...
func (mock *MockConfigMapsInterface) List(context context.Context, opts metav1.ListOptions) (*v1.ConfigMapList, error) {
...
func (mock *MockConfigMapsInterface) Create(context context.Context, cfgmap *v1.ConfigMap, opts metav1.CreateOptions) (*v1.ConfigMap, error) {
...
func (mock *MockConfigMapsInterface) Update(context context.Context, cfgmap *v1.ConfigMap, opts metav1.UpdateOptions) (*v1.ConfigMap, error) {
	name := cfgmap.ObjectMeta.Name
...
func (mock *MockConfigMapsInterface) Delete(context context.Context, name string, opts metav1.DeleteOptions) error {
	if _, ok := mock.objects[name]; !ok {
...
func (mock *MockSecretsInterface) Get(context context.Context, name string, options metav1.GetOptions) (*v1.Secret, error) {
	object, ok := mock.objects[name]
	if !ok {
		return nil, apierrors.NewNotFound(v1.Resource("tests"), name)
	}
...
func (mock *MockSecretsInterface) List(context context.Context, opts metav1.ListOptions) (*v1.SecretList, error) {
...
func (mock *MockSecretsInterface) Create(context context.Context, secret *v1.Secret, opts metav1.CreateOptions) (*v1.Secret, error) {
...
func (mock *MockSecretsInterface) Update(context context.Context, secret *v1.Secret, opts metav1.UpdateOptions) (*v1.Secret, error) {
	name := secret.ObjectMeta.Name
	if _, ok := mock.objects[name]; !ok {
		return nil, apierrors.NewNotFound(v1.Resource("tests"), name)
	}
...
func (mock *MockSecretsInterface) Delete(context context.Context, name string, opts metav1.DeleteOptions) error {
	if _, ok := mock.objects[name]; !ok {
		return apierrors.NewNotFound(v1.Resource("tests"), name)
	}
	delete(mock.objects, name)
